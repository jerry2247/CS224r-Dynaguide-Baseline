...
def train(config, device, auto_remove_exp=False, goal_dir = None, seed = None):
    """
    ...
    if config.experiment.rollout.enabled:
        ...
        for env_name in env_names:
            ...
            if config.use_goals: # new addition 
    ...
    TrainUtils.save_model(
                ...
                ckpt_path=os.path.join(ckpt_dir, "initial" + ".pth"),
...
def main(args):
    ...
    try:
        important_stats = train(config, device=device, auto_remove_exp=args.auto_remove_exp, goal_dir = args.goal_dir, seed = args.seed)
