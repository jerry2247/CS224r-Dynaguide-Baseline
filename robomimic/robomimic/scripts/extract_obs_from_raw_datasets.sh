...
BASE_DATASET_DIR="/home/maxjdu/repos/robotrainer/dataset"
...
python dataset_states_to_obs.py --done_mode 2 \
--dataset $BASE_DATASET_DIR/lift/ph/demo_v141.hdf5 \
--output_name image_v141.hdf5 --camera_names agentview robot0_eye_in_hand --camera_height 224 --camera_width 224
