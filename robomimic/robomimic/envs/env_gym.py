...
try:
    ...
    print("WARNING: unable to load franka kitchen environment")
...
class EnvGym(EB.EnvBase):
    ...
    def reset_to(self, state):
        ...
        """
        return self.env.unwrapped.reset(state) 
        # TODO: this is not the original implementation
    ...
    def get_state(self):
        ...
        return state 
        # todo: this is not aligned with the previous version 
    ...
    def get_goal(self):
        ...
        """
        if hasattr(self.env.unwrapped, "get_goal"):
            return self.env.unwrapped.get_goal()
        raise NotImplementedError
    ...
    def set_goal(self, **kwargs):
        ...
        """
        if hasattr(self.env.unwrapped, "set_goal"):
            return self.env.unwrapped.set_goal(**kwargs)
        raise NotImplementedError
    ...
    def create_for_data_processing(
        ...
        **kwargs,
        ...
        raise Exception("Not implemented yet for image states!")
        obs_modality_specs = {
            "obs": {
                "low_dim": ["flat"],
                "rgb": [],
